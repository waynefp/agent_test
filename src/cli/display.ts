...
export function displayHelp(): void {
  ...
  console.log(chalk.cyan('  /save [title]') + '          - Save current conversation');
  console.log(chalk.cyan('  /load <id>') + '             - Load a saved conversation');
  console.log(chalk.cyan('  /sessions') + '              - List all saved conversations');
  console.log(chalk.cyan('  /delete-session <id>') + '   - Delete a saved conversation');
